...
public class China : MonoBehaviour
{
    ...
    private string G_DIALOG_1 = "This wall is longer than I thought it was going to be!";
    private string G_DIALOG_2 = "It seems they call this the Great Wall of China.";
    private string G_DIALOG_3 = "Let's ask Bigglesmorf for a ride out of Antarctica. How do we get there?";
    private string G_DIALOG_4 = "HELLO";

    private string S_DIALOG_1 = "It reminds me of our rainbow sky bridge back home on planet Borf.";
    private string S_DIALOG_2 = "I see why, but I'm starting to miss home.";
    private string S_DIALOG_3 = "HELLO";
    ...
    private string PLANE_COST = "- $18,500 SPENT FROM OUR PIGGY BANK";
    private string PLANE_TIME = "AFTER 17 HOURS 41 MINUTES ...";
    private string PLANE_EMISSIONS = "- 3,238.24 KG OF CARBON DIOXIDE EMISSIONS";
    ...
    private string BOAT_COST = "- $7,600 SPENT FROM OUR PIGGY BANK";
    private string BOAT_TIME = "AFTER 13 DAYS 11 HOURS ...";
    private string BOAT_EMISSIONS = "- 241.28 KG OF CARBON DIOXIDE EMISSIONS";

    private string ARRIVAL_MESSAGE = "WE ARRIVED TO ANTARCTICA!";
    ...
    IEnumerator TransitionScreen(int vehicleChoice)
    {
        ...
        SceneManager.LoadScene("06_Antarctica");
    }
